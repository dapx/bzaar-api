defmodule BzaarWeb.UserAddressView do
  use Bzaar.Web, :view

  def render("index.json", %{user_address: user_address}) do
    %{data: render_many(user_address, BzaarWeb.UserAddressView, "user_address.json")}
  end

  def render("show.json", %{user_address: user_address}) do
    %{data: render_one(user_address, BzaarWeb.UserAddressView, "user_address.json")}
  end
