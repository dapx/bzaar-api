defmodule BzaarWeb.ItemCartView do
  use Bzaar.Web, :view

  def render("index.json", %{item_cart: item_cart}) do
    %{data: render_many(item_cart, BzaarWeb.ItemCartView, "item_cart.json")}
  end

  def render("index_product.json", %{item_cart: item_cart}) do
    %{data: render_many(item_cart, BzaarWeb.ItemCartView, "item.json")}
  end

  def render("show.json", %{item_cart: item_cart}) do
    %{data: render_one(item_cart, BzaarWeb.ItemCartView, "item_cart.json")}
  end
