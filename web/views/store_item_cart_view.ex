defmodule Bzaar.StoreItemCartView do
  use Bzaar.Web, :view

  def render("index.json", %{store_item_cart: store_item_cart}) do
    %{data: render_many(store_item_cart, Bzaar.StoreItemCartView, "item_cart.json")}
  end

  def render("index_product.json", %{store_item_cart: store_item_cart}) do
    %{data: render_many(store_item_cart, Bzaar.StoreItemCartView, "item.json")}
  end

  def render("show.json", %{store_item_cart: store_item_cart}) do
    %{data: render_one(store_item_cart, Bzaar.StoreItemCartView, "item_cart.json")}
  end
