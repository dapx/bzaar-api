defmodule Bzaar.DispatcherView do
  use Bzaar.Web, :view

  def render("index.json", %{dispatchers: dispatchers}) do
    %{data: render_many(dispatchers, Bzaar.DispatcherView, "dispatcher.json")}
  end

  def render("show.json", %{dispatcher: dispatcher}) do
    %{data: render_one(dispatcher, Bzaar.DispatcherView, "dispatcher.json")}
  end
